...
Dieses Template wurde lokal in das Repo hinzugefügt, weil es modifiziert wurde.
Das Template wurde so modifiziert, dass es den Pfad zum Bild zurück gibt.
```
Mitja Perko 30.01.2023
```
---
